...
//echo "POST SETSCH";
	...
	$inuse = file_get_contents("/var/www/active");
	$set = $inuse;
	$setnow = shell_exec('/scripts/./timercreate');
	}
}
else
{
...
<body>
<a href="."><button>Control</button></a>
<br>
...
<form method="POST" action=''>
<input type="submit" name="change" value="Update now">
</form></div>
<?php
...
if ($result->num_rows > 0) {
     echo "<table>";
     echo "<th colspan=6>Currently showing: " . $set . "</th><th colspan=5>Currently active: " . $inuse . "</th>";
     // output data of each row
     echo "<tr><th colspan='11'>Central Heating</th></tr>";
     while($row = $result->fetch_assoc()) {
       echo "<tr><td class='day'>" . $row["DAY"]. "</td><td>" . $row["CHON1"]. "</td><td>" . $row["CHOFF1"]. "</td><td>" . $row["CHON2"]. "</td><td>" . $row["CHOFF2"]. "</td><td>" . $row["CHON3"]. "</td><td>" . $row["CHOFF3"]. "</td><td>" . $row["CHON4"]. "</td><td>" . $row["CHOFF4"]. "</td><td>" . $row["CHON5"]. "</td><td>" . $row["CHOFF5"]. "</td></tr>";
     }
     echo "</table>";
} else {
     echo "0 results";
...
if ($result->num_rows > 0) {
     echo "<table>";
     // output data of each row
     echo "<tr><th colspan='11'>Hot Water</th></tr>";
     while($row = $result->fetch_assoc()) {
        echo "<tr><td class='day'>" . $row["DAY"]. "</td><td>" . $row["HWON1"]. "</td><td>" . $row["HWOFF1"]. "</td><td>" . $row["HWON2"]. "</td><td>" . $row["HWOFF2"]. "</td><td>" . $row["HWON3"]. "</td><td>" . $row["HWOFF3"]. "</td><td>" . $row["HWON4"]. "</td><td>" . $row["HWOFF4"]. "</td></tr>";
     }
     echo "</table>";
} else {
     echo "0 results";
